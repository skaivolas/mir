...
! function()
{
    ...
    e.version = "2.0.0", e.utils = {}, e.utils.warn = function(e)
        {
            return function(t)
            {
        ...
        }, e.tokenizer = function(t)
        {
            ...
            for (var r = t.toString().trim().toLowerCase(), i = r.length, n = [], s = 0, o = 0; i >= s; s++)
            {
                var a = r.charAt(s),
                    u = s - o;
                (a.match(e.tokenizer.separator) || s == i) && (u > 0 && n.push(new e.Token(r.slice(o, s),
                {
                    position: [o, u],
                    index: n.length
                })), o = s + 1)
        ...
        {
            this._stack = []
        }, e.Pipeline.registeredFunctions = {}, e.Pipeline.registerFunction = function(t, r)
        {
        ...
        {
            for (var t = this._stack.length, r = 0; t > r; r++)
            {
                var i = this._stack[r];
        ...
        {
            if (this._magnitude = 0, 0 == this.elements.length) return void this.elements.push(e, t);
            for (var r = 0, i = this.elements.length, n = i - r, s = 2 * Math.floor(n / 2 / 2), o = this.elements[s]; n > 2;)
            {
                if (o == e) throw "duplicate index";
                e > o && (r = s), o > e && (i = s), n = i - r, s = r + 2 * Math.floor(n / 2 / 2), o = this.elements[s]
            }
            o > e && this.elements.splice(s, 0, e, t), e > o && this.elements.splice(s + 2, 0, e, t)
        }, e.Vector.prototype.magnitude = function()
        {
            if (this._magnitude) return this._magnitude;
            for (var e = 0, t = this.elements.length, r = 1; t > r; r += 2)
            {
        ...
        {
            for (var t = 0, r = this.elements, i = e.elements, n = r.length, s = i.length, o = 0, a = 0, u = 0, h = 0; n > u && s > h;) o = r[u], a = i[h], a > o ? u += 2 : o > a ? h += 2 : o == a && (t += r[u + 1] * i[h + 1], u += 2, h += 2);
            return t
        ...
        }, e.stemmer = function()
        {
            var e = {
                ...
                w = new RegExp("^" + n + i + "[^aeiouwxy]$"),
                Q = /^(.+?[^aeiou])y$/,
                L = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,
                T = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,
                S = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,
                b = /^(.+?)(s|t)(ion)$/,
                P = /^(.+?)e$/,
                E = /ll$/,
                I = new RegExp("^" + n + i + "[^aeiouwxy]$"),
                _ = function(r)
                {
                    var i, n, s, o, a, u, h;
                    if (r.length < 3) return r;
                    if (s = r.substr(0, 1), "y" == s && (r = s.toUpperCase() + r.substr(1)), o = f, a = m, o.test(r) ? r = r.replace(o, "$1$2") : a.test(r) && (r = r.replace(a, "$1$2")), o = y, a = v, o.test(r))
                    {
                        var _ = o.exec(r);
                        o = d, o.test(_[1]) && (o = g, r = r.replace(o, ""))
                    }
                    else if (a.test(r))
                    {
                        var _ = a.exec(r);
                        i = _[1], a = p, a.test(i) && (r = i, a = x, u = k, h = w, a.test(r) ? r += "e" : u.test(r) ? (o = g, r = r.replace(o, "")) : h.test(r) && (r += "e"))
                    }
                    if (o = Q, o.test(r))
                    {
                        var _ = o.exec(r);
                    ...
                    {
                        var _ = o.exec(r);
                        i = _[1], n = _[2], o = d, o.test(i) && (r = i + e[n])
                    }
                    if (o = T, o.test(r))
                    {
                        var _ = o.exec(r);
                        i = _[1], n = _[2], o = d, o.test(i) && (r = i + t[n])
                    }
                    if (o = S, a = b, o.test(r))
                    {
                        var _ = o.exec(r);
                        i = _[1], o = l, o.test(i) && (r = i)
                    }
                    else if (a.test(r))
                    {
                        var _ = a.exec(r);
                        i = _[1] + _[2], a = l, a.test(i) && (r = i)
                    }
                    if (o = P, o.test(r))
                    {
                        var _ = o.exec(r);
                        i = _[1], o = l, a = c, u = I, (o.test(i) || a.test(i) && !u.test(i)) && (r = i)
                    }
                    return o = E, a = l, o.test(r) && a.test(r) && (o = g, r = r.replace(o, "")), "y" == s && (r = s.toLowerCase() + r.substr(1)), r
                };
            return function(e)
            {
                return e.update(_)
        ...
        }(), e.Pipeline.registerFunction(e.stemmer, "stemmer"), e.generateStopWordFilter = function(e)
        {
            ...
            return function(e)
            {
                return e && t[e.toString()] !== e.toString() ? e : void 0
            }
        }, e.stopWordFilter = e.generateStopWordFilter([]), e.Pipeline.registerFunction(e.stopWordFilter, "stopWordFilter"), e.trimmer = function(e)
        {
            return e.update(function(e)
            {
                return e.replace(/^[^\wĉŝĥĵẑĝĈŜĤĴẐĜа-яёА-ЯЁіІўЎ'’]+/, "").replace(/[^\wĉŝĥĵẑĝĈŜĤĴẐĜа-яёА-ЯЁіІўЎ'’]+$/, "")
            })
        ...
        {
            for (var r = new e.TokenSet.Builder, i = 0, n = t.length; n > i; i++) r.insert(t[i]);
        ...
        }, e.TokenSet.fromFuzzyString = function(t, r)
        {
                ...
                }]; n.length;)
            {
                ...
                {
                    var u, a = s.str.charAt(1);
                    a in s.node.edges ? u = s.node.edges[a] : (u = new e.TokenSet, s.node.edges[a] = u), s.str.length <= 2 ? u.final = !0 : n.push(
                    {
                        node: u,
                ...
                {
                    if ("*" in s.node.edges) var h = s.node.edges["*"];
                    else
                    {
                        var h = new e.TokenSet;
                        s.node.edges["*"] = h
                    }
                    1 == s.str.length ? h.final = !0 : n.push(
                    {
                        node: h,
                        editsRemaining: s.editsRemaining - 1,
                        str: s.str.slice(1)
                ...
                {
                    if ("*" in s.node.edges) var d = s.node.edges["*"];
                    else
                    {
                ...
                if (s.editsRemaining > 0 && s.str.length > 1)
                {
                    var l, c = s.str.charAt(0),
                        p = s.str.charAt(1);
                    p in s.node.edges ? l = s.node.edges[p] : (l = new e.TokenSet, s.node.edges[p] = l), 1 == s.str.length ? l.final = !0 : n.push(
                    {
                        node: l,
                        editsRemaining: s.editsRemaining - 1,
                        str: c + s.str.slice(2)
        ...
        {
            for (var r = new e.TokenSet, i = r, n = !1, s = 0, o = t.length; o > s; s++)
            {
                var a = t[s],
                    u = s == o - 1;
                ...
                {
                    var h = new e.TokenSet;
                    h.final = u, r.edges[a] = h, r = h, n && (r.edges["*"] = i)
                }
            }
            return i
        ...
        }, e.TokenSet.prototype.toString = function()
        {
            ...
            for (var e = this.final ? "1" : "0", t = Object.keys(this.edges).sort(), r = t.length, i = 0; r > i; i++)
            {
                var n = t[i],
                    s = this.edges[n];
                e = e + n + s.id
        ...
        }, e.TokenSet.prototype.intersect = function(t)
        {
            ...
            {
                i = n.pop();
                for (var s = Object.keys(i.qNode.edges), o = s.length, a = Object.keys(i.node.edges), u = a.length, h = 0; o > h; h++)
                    for (var d = s[h], l = 0; u > l; l++)
                    {
                        var c = a[l];
                        if (c == d || "*" == d)
                        {
                            var p = i.node.edges[c],
                                f = i.qNode.edges[d],
                                m = p.final && f.final,
                                y = void 0;
                            c in i.output.edges ? (y = i.output.edges[c], y.final = y.final || m) : (y = new e.TokenSet, y.final = m, i.output.edges[c] = y), n.push(
                            {
                                qNode: f,
                                output: y,
                                node: p
        ...
        {
            this.invertedIndex = e.invertedIndex, this.documentVectors = e.documentVectors, this.tokenSet = e.tokenSet, this.documentCount = e.documentCount, this.averageDocumentLength = e.averageDocumentLength, this.b = e.b, this.k1 = e.k1, this.fields = e.fields, this.pipeline = e.pipeline
        ...
        }, e.Index.prototype.query = function(t)
        {
            var r = new e.Query(this.fields),
                ...
                n = new e.Vector;
            t.call(r, r);
            for (var s = 0; s < r.clauses.length; s++)
            {
                var o = r.clauses[s],
                    a = null;
                ...
                for (var u = 0; u < a.length; u++)
                {
                    var h = a[u];
                    o.term = h;
                    for (var d = e.TokenSet.fromClause(o), l = this.tokenSet.intersect(d).toArray(), c = 0; c < l.length; c++)
                    {
                        var p = l[c],
                            f = this.invertedIndex[p],
                            m = f._index,
                            y = e.idf(f, this.documentCount),
                            v = 1,
                            g = y * (this.k1 + 1) * v / (this.k1 * (1 - this.b + this.b * (r.clauses.length / this.averageDocumentLength)) + v);
                        n.insert(m, g * o.boost);
                        for (var x = 0; x < o.fields.length; x++)
                            for (var k = o.fields[x], w = f[k], Q = Object.keys(w), L = 0; L < Q.length; L++)
                            {
                                var T, S, b = Q[L];
                                T = w[b], S = new e.MatchData(p, k, T), b in i ? i[b].combine(S) : i[b] = S
                            }
                    }
                }
            }
            for (var Q = Object.keys(i), P = [], s = 0; s < Q.length; s++)
            {
                var E = Q[s],
                    I = this.documentVectors[E],
                    g = n.similarity(I);
                P.push(
                {
                    ref: E,
        ...
        }, e.Index.prototype.toJSON = function()
        {
            var t = Object.keys(this.invertedIndex).sort().map(function(e)
                ...
                r = Object.keys(this.documentVectors).map(function(e)
                {
                    return [e, this.documentVectors[e].toJSON()]
                }, this);
            return {
                version: e.version,
        ...
        }, e.Index.load = function(t)
        {
            var r = {},
                ...
                o = {},
                a = t.invertedIndex,
                u = new e.TokenSet.Builder,
                h = e.Pipeline.load(t.pipeline);
            ...
            return u.finish(), r.b = t.b, r.k1 = t.k1, r.fields = t.fields, r.averageDocumentLength = t.averageDocumentLength, r.documentCount = s, r.documentVectors = i, r.invertedIndex = o, r.tokenSet = u.root, r.pipeline = h, new e.Index(r)
        }, e.Builder = function()
        {
            this._ref = "id", this._fields = [], this.invertedIndex = {}, this.documentTermFrequencies = {}, this.documentLengths = {}, this.tokenizer = e.tokenizer, this.pipeline = new e.Pipeline, this.searchPipeline = new e.Pipeline, this.documentCount = 0, this._b = .75, this._k1 = 1.2, this.termIndex = 0, this.metadataWhitelist = []
        ...
        {
            this._b = 0 > e ? 0 : e > 1 ? 1 : e
        }, e.Builder.prototype.k1 = function(e)
        {
            this._k1 = e
        }, e.Builder.prototype.add = function(e)
        {
            var t = e[this._ref],
                r = {};
            this.documentCount += 1, this.documentTermFrequencies[t] = r, this.documentLengths[t] = 0;
            for (var i = 0; i < this._fields.length; i++)
            {
                ...
                this.documentLengths[t] += a.length;
                for (var u = 0; u < a.length; u++)
                {
                    var h = a[u];
                    if (void 0 == r[h] && (r[h] = 0), r[h] += 1, void 0 == this.invertedIndex[h])
                    {
                        var d = {
                            _index: this.termIndex
                        };
                        this.termIndex += 1;
                        for (var l = 0; l < this._fields.length; l++) d[this._fields[l]] = {};
                        this.invertedIndex[h] = d
                    }
                    void 0 == this.invertedIndex[h][n][t] && (this.invertedIndex[h][n][t] = {});
                    for (var c = 0; c < this.metadataWhitelist.length; c++)
                    {
                        var p = this.metadataWhitelist[c],
                            f = h.metadata[p];
                        void 0 == this.invertedIndex[h][n][t][p] && (this.invertedIndex[h][n][t][p] = []), this.invertedIndex[h][n][t][p].push(f)
                    }
                }
            }
        }, e.Builder.prototype.calculateAverageDocumentLengths = function()
        {
            for (var e = Object.keys(this.documentLengths), t = e.length, r = 0, i = 0; t > i; i++)
            {
                var n = e[i];
                r += this.documentLengths[n]
            }
            this.averageDocumentLength = r / t
        }, e.Builder.prototype.createDocumentVectors = function()
        {
            for (var t = {}, r = Object.keys(this.documentTermFrequencies), i = r.length, n = 0; i > n; n++)
            {
                for (var s = r[n], o = this.documentLengths[s], a = new e.Vector, u = this.documentTermFrequencies[s], h = Object.keys(u), d = h.length, l = 0; d > l; l++)
                {
                    var c = h[l],
                        p = u[c],
                        f = this.invertedIndex[c]._index,
                        m = e.idf(this.invertedIndex[c], this.documentCount),
                        y = m * (this._k1 + 1) * p / (this._k1 * (1 - this._b + this._b * (o / this.averageDocumentLength)) + p);
                    a.insert(f, y)
                }
                t[s] = a
            }
            this.documentVectors = t
        ...
        {
            return this.calculateAverageDocumentLengths(), this.createDocumentVectors(), this.createTokenSet(), new e.Index(
            {
        ...
        }, e.MatchData.prototype.combine = function(e)
        {
            for (var t = Object.keys(e.metadata), r = 0; r < t.length; r++)
            {
                ...
                for (var s = 0; s < n.length; s++)
                {
                    ...
                    {
                        var h = a[u];
                        this.metadata[i][o][h] = void 0 == this.metadata[i][o][h] ? e.metadata[i][o][h] : this.metadata[i][o][h].concat(e.metadata[i][o][h])
                    }
                }
            }
        }, e.Query = function(e)
        ...
        }, e.Query.prototype.clause = function(e)
        {
            return "fields" in e || (e.fields = this.allFields), "boost" in e || (e.boost = 1), "usePipeline" in e || (e.usePipeline = !0), this.clauses.push(e), this
        ...
        {
            this.lexemes = [], this.str = e, this.length = e.length, this.pos = 0, this.start = 0
        ...
        {
            var t, r;
            do t = this.next(), r = t.charCodeAt(0); while (r > 47 && 58 > r);
        ...
        {
            return t.width() > 1 && (t.backup(), t.emit(e.QueryLexer.TERM)), t.ignore(), t.more() ? e.QueryLexer.lexText : void 0
        ...
        }, e.QueryLexer.lexText = function(t)
        {
            for (;;)
            {
                ...
                if (" " == r) return e.QueryLexer.lexTerm
            }
        ...
        }, e.QueryParser.parseFieldOrTerm = function(t)
        {
            ...
            if (void 0 != r) switch (r.type)
            {
                ...
                default:
                    var i = "expected either a field or a term, found " + r.type + " with value '" + r.str + "'";
            ...
            if (void 0 != r)
            {
                ...
                switch (s.type)
                {
                    case e.QueryLexer.TERM:
                        return e.QueryParser.parseTerm;
                    default:
                        var n = "expecting a field, found '" + s.type + "'";
